...
if(ana_type.compare("grid")==0|| ana_type.compare("grid_test")==0|| ana_type.compare("grid_merge")==0|| ana_type.compare("grid_download")==0){
  ...
  cout <<"2015       for 20 data" <<endl;
  cout <<"201511     for  2015 montecarlo data " <<endl;
  cout <<"20181      for  2018 q  data "<<endl;
  
  cout <<"20182      for  2018 r  data "<<endl;
  
  cout <<"201811     for 2018 q montecarlo data "<<endl;
  
  cout <<"201811     for 2018 q montecarlo data "<<endl;
  
  cout <<"201821     for 2018 r montecarlo data "<<endl;
  cin>> year_data;
 ...
 cout<<"running it locally"<<endl;
    ...
    cout<< "acutally running it on grid"<< endl;
      ...
      //  }
        ...
        // select the input data for 2018 q
         ...
         //lhc16b2c is for psi2s to muons  the channel can be found in the sim.log file inside the run number folder in grid dir location 
          ...
          cout<<"enter the mc channel you need"<<endl;
             cout<<"psi for CohPsi2sToMuPi /n jpsi for CohJpsiToMu "<<endl;
             cin>>channel;    
           
             if(channel.compare("psi")==0){
             //this is for coherent jpsi to mumu LHC16b2b is for incoherent
      	      alienHandler->SetGridDataDir("/alice/sim/2015/LHC16b2c");
      	      }
             else if(channel.compare("jpsi")==0){ 
               alienHandler->SetGridDataDir("/alice/sim/2015/LHC16b2a");
               }
        ...
        TString LHC15("LHC15");
        TString LHC18qMCJP("LHC18qMCJP");
        TString LHC18rMCJP("LHC18rMCJP");
        TString LHC18qMCPsi2s("LHC18qMCPsi2s");
        TString LHC18rMCPsi2s("LHC18rMCPsi2s");
        TString LHC16b2MCJp("LHC16b2MCJp");
        TString LHC16b2MCPsi2s("LHC16b2MCPsi2s");
