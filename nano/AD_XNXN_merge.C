void AD_XNXN_merge(const char *dir, Int_t stage=0)
{
...
// Analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliAnalysisTaskPolarizationTestJP.cxx+g");
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("AD_XNXN.root");
   if (!mgr) {
